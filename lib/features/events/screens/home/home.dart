...
import 'package:eventtm/features/events/screens/details/event_details.dart';
          ...
          Column(
            children: [
              Padding(
                ...
                child: EventTMSectionHeading(
                  title: 'EventTM top picks',
                  onPressed: () {},
                ),
              ),
              SizedBox(
                child: Padding(
                    ...
                    child: Column(
                      children: [
                        EventTMCarouselWithIndicatorWidget(imgList: imgList),
              ...
              EventTMGridLayout(
                itemCount: 2,
                itemBuilder: (_, index) => EventTMCardVertical(
                  imageUrl: EventTMImages.exitclub,
                  showBorder: true,
                  onTap: () => Get.to(() => const Eventdetail()),
                ),
              )
            ],
          ),
